...
| [Obama-McCain Debate](http://help.sentiment140.com/for-students) (OMD)   	| The Obama-McCain Debate (OMD) dataset was constructed from 3,238 tweets crawled during the first U.S. presidential TV debate in September 2008. Sentiment labels were acquired for these tweets using Amazon Mechanical Turk, where each tweet was rated by at least three annotators as either positive, negative, mixed, or other. 	| [download link](https://bitbucket.org/speriosu/updown/src/1deb8fe45f60/data/shamma/orig/debate08_sentiment_tweets.tsv?at=default&fileviewer=file-view-default)   	| e sentiment labels, which two-third of the voters agree on, as final labels of the tweets |
| [STS-Gold](http://help.sentiment140.com/for-students)   	|  The STSGold dataset contains 13 negative, 27 positive and 18 neutral entities as well as 1,402 negative, 632 positive and 77 neutral tweets. ([details in Section 3](http://oro.open.ac.uk/40660/1/paper1.pdf)) 	| [download link](http://tweenator.com/index.php?page_id=13)   	| 0=negative, 4=positive |
